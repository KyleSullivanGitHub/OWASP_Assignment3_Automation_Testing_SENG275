...
//TODO maybe switch from multiple parameters to a builder pattern or an object?
    ...
    public static Object[][] LG1_Input()
    {
        ...
        return new Object[][]{
                //{"Firefox", new Object[]{email+randomNum1+"@gmail.com",password,question}},
                {"Chrome", new Object[]{email+randomNum2+"@gmail.com",password,question}},
               // {"Edge", new Object[]{email+randomNum3+"@gmail.com",password,question}}, //Edge is causing issues, always needs to be in focus for the test to actually pass. need to fix
               // {"Safari", email+randomNum4+"@gmail.com",password,question}
        };
    }
